...
#   ------------------------------------------------------------
    export CLICOLOR=1 # 색상 적용 여부
    export LSCOLORS=GxFxCxDxBxegedabagaced # 디렉토리 색상 적용 여부 (dark ver)
...
# cd() { builtin cd "$@"; ll; }               # Always list directory contents upon 'cd' kind of annoying
